  ...
  return (
    <SectionMotion>
      <Box
        component="section"
        id="projects"
        sx={{ mb: { xs: 7, md: 10 }, scrollMarginTop: 96 }}
      >
        <SectionHeading
            ...
            >
              <CardContent
                sx={{
                  ...
                  gridTemplateColumns: {
                    xs: "1fr",
                    md: "minmax(0, 0.9fr) minmax(320px, 1fr)",
                  },
                  p: { xs: 2.5, md: 3.5 },
              ...
              >
                <Box>
                  ...
                  <Typography
                    component="h3"
                    variant="h3"
                    sx={{ fontSize: { xs: "1.45rem", md: "1.75rem" }, mb: 1 }}
                  >
                    {featuredProject.title}
                  </Typography>
                  <Typography
                    color="text.secondary"
                    sx={{ fontSize: "1.02rem", lineHeight: 1.65 }}
                  >
